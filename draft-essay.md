...
But in reality, whether or not the application of Artificial Intelligence in consumer devices is good decision can only be decided by one thing. The consumers. If it is a good decision, then we'll see a rise in devices that utilise this technology over the next few years as consumer continue to buy the products featuring it. Otherwise, as the popularity of the technology dwindles, fewer and fewer devices will use it and it will fade into the obscurity of business applications until such time that the technology is mature enough to be affordable and powerful.
